...
export const regAddrMap = {
  ...
  0xA0C: { shortName: 'QCR',     longName: 'Queuing Control Register (write-only)' },
  ...
  0xA84: { shortName: 'IRC_CLR', longName: 'Interrupt Controller Raw Status Clear Register (write-only)' },
  ...
  0xC40: { shortName: 'LOCK', longName: 'Unlock Sequence Register (write-only)' },
  0xC44: { shortName: 'CTRL', longName: 'Control Register (write-only)' },
